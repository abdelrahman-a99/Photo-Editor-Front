  ...
  return (
    <div className="container mx-auto py-6 flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold">Histogram Analysis</h2>
      </div>
        ...
        <div className="lg:col-span-1 space-y-6">
          <Card>
            <CardHeader className="px-4 py-3">
              <CardTitle className="text-base">Histogram Functions</CardTitle>
            </CardHeader>
          ...
          <Card className="min-h-[200px]">
            <CardHeader className="px-4 py-3">
              <CardTitle className="text-base">Histogram Chart</CardTitle>
            </CardHeader>
